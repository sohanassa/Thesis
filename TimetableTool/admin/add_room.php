...
<?php else : ?>
  ...
  <body style="background-color: #818589;">
    ...
    <div style="width: 30%; margin: 0 auto;">
      <h2 style="text-align: center;">Enter room information</h2>
      <form method="post" action="add_room.php">
        <?php include(dirname(dirname(__FILE__)) . '/errors.php'); ?>
        <div class="form-group">
          <label for="add_room_number">Room number/code</label>
          <input class="form-control" type="text" id="add_room_number" placeholder="B101" name="add_room_number" required>
        </div>
        <div class="form-group">
          <label for="add_room_capacity">Room capacity</label>
          <input class="form-control" type="text" id="add_room_capacity" placeholder="35" name="add_room_capacity" required>
        </div>
        <div style="height: 10px;"></div>
        <div style="text-align: center; display:flex; justify-content: center;">
          <button type="submit" class="btn btn-outline-light" name="add_room">Submit</button>
        </div>
      </form>
    </div>

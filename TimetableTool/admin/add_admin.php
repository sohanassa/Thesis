        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="add_admin.php" style="color:blanchedalmond">Add an administrator</a>
              </li>
              <li class="nav-item">
    ...
    <div style="width: 30%; margin: 0 auto;">
      ...
      <form method="post" action="add_admin.php">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="text" id="password" placeholder="Enter password" name="add_admin_password" required>
        </div>

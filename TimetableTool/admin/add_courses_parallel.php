...
<?php else : ?>
  ...
  <body style="background-color: #818589;">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="add_courses_parallel.php" style="color:blanchedalmond">Add courses in parallel</a>
              </li>
              <li class="nav-item">
    ...
    <div style="width: 30%; margin: 0 auto;">
      <h2 style="text-align: center;">Enter courses that should be taught at the same time</h2>

...
<?php else : ?>
  ...
  <body style="background-color: #818589;">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="register_inst.php" style="color:blanchedalmond">Register an Instructor</a>
              </li>
              <li class="nav-item">
            ...
            ?>
              <ul class="navbar-nav navbar-right">
                <li>
                  <form action="register_inst.php" method="post" id="logout_b">
    ...
    <div style="width: 30%; margin: 0 auto;">
      <br>
      <h2 style="text-align: center;">Register an Instructor</h2>
      <form method="post" action="register_inst.php">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="text" placeholder="Enter surname" required name="surname">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="text" id="password" placeholder="Enter password" name="password" required>
        </div>
        <div class="form-group">
          <label for="inst_username">Username</label>
          <input class="form-control" type="text" id="inst_username" placeholder="Enter username" name="inst_username" required>
        </div>
        <div style="height: 10px;"></div>
        <div style="text-align: center; display:flex; justify-content: center;">
          <button type="submit" class="btn btn-outline-light" name="reg_user">Submit</button>
        </div>
      </form>
    </div>

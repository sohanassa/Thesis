...
<?php else : ?>
    ...
    <body style="background-color: #818589;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="unavailable_hours_w.php" style="color:blanchedalmond">Add unavailability</a>
                            </li>
        ...
        <div style="width: 40%; margin: 0 auto;">
            ...
            <br>
            <form method="post" action="unavailable_hours_w.php">
                <?php include(dirname(dirname(__FILE__)) . '/errors.php'); ?>
                <h5 style="text-align: center;">On which of the following hours on Wednesday you can not teach:</h5>
                <div style="width: 40%; margin: 0 auto;">
                    <ul class="list-group">
                ...
                <div style="text-align: center; display:flex; justify-content: center;">
                    <button type="submit" class="btn btn-outline-light" name="add_unavailable_hours_w">Submit and continue</button>
                </div>
            </form>
        </div>
        <br><br><br><br><br>

...
<?php else : ?>
    ...
    <body style="background-color: #818589;">
        ...
        <div style="width: 40%; margin: 0 auto;">
            ...
            <br>
            <form method="post" action="pref_hours_w.php">
                <?php include(dirname(dirname(__FILE__)) . '/errors.php'); ?>
                <h5 style="text-align: center;">On which of the following hours on <b>Wednesday</b> do you preffer to teach this course:</h5>
                <div style="width: 40%; margin: 0 auto;">
                    <ul class="list-group">
                ...
                <div style="text-align: center; display:flex; justify-content: center;">
                    <button type="submit" class="btn btn-outline-light" name="add_preferred_hours_w">Submit and continue</button>
                </div>
            </form>
        </div>
        <br><br><br><br><br>

...
<?php else : ?>
    ...
    <body style="background-color: #818589;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="pref_days.php" style="color:blanchedalmond">Add course/lab preferred hours</a>
                            </li>
                            <li class="nav-item">
        ...
        <div style="width: 40%; margin: 0 auto;">
            <h4 style="text-align: center;">Specify the prefered hours for teaching this course</h4>
            <br>
            <form method="post" action="pref_days.php">
                <?php include(dirname(dirname(__FILE__)) . '/errors.php'); ?>
                <h5 style="text-align: center;">On which of the following days would you prefer to teach the course:</h5>
                <div style="width: 40%;  margin: 0 auto;">
                    <ul class="list-group">
                        <li class="list-group-item" style="background-color: #6a6e73;">
                            ...
                            <label class="form-check-label" for="monday_thursday">Monday and Thursday</label>
                        </li>
                        <li class="list-group-item" style="background-color: #6a6e73;">
                        ...
                        <li class="list-group-item" style="background-color: #6a6e73;">
                            ...
                            <label class="form-check-label" for="tuesday_friday">Tuesday and Friday</label>
                        </li>
                    </ul>
                </div>
                <div style="height: 10px;"></div>
                <div style="text-align: center; display:flex; justify-content: center;">
                    <button type="submit" class="btn btn-outline-light" name="add_pref_days">Submit and continue</button>
                </div>
            </form>
        </div>

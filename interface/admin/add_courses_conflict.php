...
<?php else : ?>
  ...
  function validateForm() {
    ...
    <div style="width: 30%; margin: 0 auto;">
      <h2 style="text-align: center;">Choose courses that should not be taught at the same time</h2>
      <form method="post" action="add_courses_conflict.php" onsubmit="return validateForm()">

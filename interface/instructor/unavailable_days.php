...
<?php else : ?>
    ...
    <body style="background-color: #818589;">
        ...
        <div style="width: 40%; margin: 0 auto;">
            <h2 style="text-align: center;">Specify days where teaching is not possible</h2>
            <br>
            <form method="post" action="unavailable_days.php">
                <?php include(dirname(dirname(__FILE__)) . '/errors.php'); ?>
                <h5 style="text-align: center;">On which of the following days you are completely Unavailable?</h5>
